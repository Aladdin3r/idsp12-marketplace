    ...
    <>
      ...
      <main className={`${styles.main}`}>
        ...
        <div className="jumbotron mb-6 sm-6">
          ...
          <Image src="/HorizontalWordmark.svg" width={500} height={400} className="center-block" />
        ...
        <div id="features" class="container-sm  mt-4">
          ...
          <div className="jumbotron mb-6 ms-6">
            <p>SafeExchange boasts an in-depth screening process for account creation, some required steps for new users to complete are:</p>
            <ul>
        ...
        <div id="download" className="container-sm  mt-4">
          <div className="row">
            <div className="col-md-6 justify-content-center">
              <h4>Links</h4>
              <p>View our Figma prototype</p>
              <Link href="https://www.figma.com/proto/WFyzAHRx2f6lgYz3UGSxS0/Wireframes?node-id=505-1373&t=apEVDRjpynC4Iaa1-0&scaling=scale-down&page-id=299%3A2268&starting-point-node-id=505%3A1373&show-proto-sidebar=1">
                <Image src='/figma.svg' width={200} height={124} />
              </Link>
            </div>
          </div>
        </div>
